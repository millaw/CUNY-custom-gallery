document.addEventListener('DOMContentLoaded', function () {
  const wrapper = document.querySelector('.cuny-gallery-wrapper');
  ...
  const loadMoreBtn = wrapper?.querySelector("#" + 'loadMoreBtn');
  const sliderTrack = wrapper?.querySelector("#" + 'sliderTrack');
  const sliderGalleryTrack = wrapper?.querySelector("#" + 'sliderGalleryTrack');
  const modal = wrapper?.querySelector("#" + 'modal');
  const modalImg = modal.querySelector('img');

  const closeModalBtn = wrapper?.querySelector("#" + 'modalClose');
  const prevModalBtn = wrapper?.querySelector("#" + 'modalPrev');
  const nextModalBtn = wrapper?.querySelector("#" + 'modalNext');
  ...
  if (sliderGalleryTrack) {
    const prevGalleryBtn = wrapper?.querySelector("#" + 'prevGalleryBtn');
    const nextGalleryBtn = wrapper?.querySelector("#" + 'nextGalleryBtn');
